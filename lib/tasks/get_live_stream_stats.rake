...
task get_live_stream_stats: :environment do
  ...
  # Start time
  start_time = 13.hours.ago.beginning_of_hour.to_i
  end_time = 12.hours.ago.beginning_of_hour.to_i
  usage_api = MuxRuby::DeliveryUsageApi.new
  usage = usage_api.list_delivery_usage(timeframe: [start_time, end_time])
